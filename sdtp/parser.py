...
#            'AI no good spot' : self.match_prefix + r'INF AIDirector: Could not find a valid position to spawn wandering horde \(trying again in 1 hour\)$',
            ...
            'AIDirector spawning scouts': self.match_prefix + r'INF AIDirector: Spawning scouts at ' + self.match_string_pos + r', towards ' + self.match_string_pos,           
...
#                                       'to_call'  : [ ] },
            ...
            'EAC Server SetLogCallback': self.match_prefix + r'INF \[EAC\] Log: \[EAC Server\]  \[Info\] \[SetLogCallback\] Procedure: 0x[\w]+ LogLevel: Verb.',
